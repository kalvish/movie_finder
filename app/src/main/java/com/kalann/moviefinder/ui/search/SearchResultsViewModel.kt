...
class SearchResultsViewModel(
    val initialQueryFromOutside :String,
    ...
    init {
        val initialQuery: String = savedStateHandle.get(LAST_SEARCH_QUERY) ?: initialQueryFromOutside
        ...
        pagingDataFlow = searches
            .flatMapLatest { searchMovies(queryString = it.query) }
    ...
    private fun searchMovies(queryString: String): Flow<PagingData<Movie>> =
        movieDataRepository.getSearchResultStream(queryString)
}
...
private const val DEFAULT_QUERY = "Kids"