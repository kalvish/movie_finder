...
//        return inflater.inflate(R.layout.fragment_top_rated, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val popularViewModelFactory = MoviesViewModelLifecycleFactory(moviesDataRepository, MFinService.PageTypes.UPCOMING)
        ...
        val movieAdapter = MovieAdapter(object : MovieAdapter.OnMovieClickListener {
            override fun onClickListItem(movie: Movie) {
                ...
                view.findNavController().navigate(R.id.action_navigation_upcoming_to_movieDetailsFragment, bundle)
            }
        })
        val decoration = DividerItemDecoration(context, DividerItemDecoration.VERTICAL)
        fragmentTopRatedBinding.recyclerViewMovies.addItemDecoration(decoration)
