...
//        val imageViewMovieType = itemView.findViewById<ImageView>(R.id.imageViewMovieType)
    ...
    fun bind(movie: Movie?) {
        if (movie == null) {
            imageViewMovie.setImageDrawable(ResourcesCompat.getDrawable(itemView.resources, R.drawable.ic_broken_image, null))
        } else {
            val stringUrl = "https://image.tmdb.org/t/p/original/" + movie.backdropPath
